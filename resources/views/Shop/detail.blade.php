	...
	<div class="shop_inner_inf">
				...
				<div class="flexslider">
					...
					<ul class="slides">
						<li data-thumb="{{ asset('images/'.$product->image) }}">
							<div class="thumb-image"> <img src="{{ asset('images/'.$product->image) }}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
						@foreach($product->images as $image)
						
						<li data-thumb="{{ asset('images/'.$image->imageURL) }}">
							<div class="thumb-image"> <img src="{{ asset('images/'.$image->imageURL) }}" data-imagezoom="true" class="img-responsive"> </div>
						</li>
		...
		<div class="col-md-8 single-right-left simpleCart_shelfItem">
			...
			<form action="{{ route('cart.add', $product->id) }}">
				...
				<div class="occasion-cart" style="margin-top: 25px">
					<div class="shoe single-item single_page_b">
						...
						{{-- <a href="{{ route('cart.add', $product->id) }}" style="background-color: black">Add To Card</a> --}}
						<button class="black-button" type="submit">Add to Card</button>
					</div>
